...
var (
	...
	blockEncodedBlockPrefix = []byte("eb") // eb = encoded block
...
func blockEncodedBlockKey(number uint64, hash common.Hash) []byte {
	return append(append(blockEncodedBlockPrefix, encodeBlockNumber(number)...), hash.Bytes()...)
}
